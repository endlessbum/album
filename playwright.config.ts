...
// Default to 5003 to avoid clashing with any existing local dev server
const E2E_BASE = process.env.PLAYWRIGHT_BASE_URL || 'http://127.0.0.1:5003';
...
export default defineConfig({
  ...
  webServer: {
    ...
    port: Number(new URL(E2E_BASE).port || 5001),
  ...
  RATE_LIMIT_DISABLED: '1',
      ...
      PORT: String(Number(new URL(E2E_BASE).port || 5001)),
    },
  },
});
